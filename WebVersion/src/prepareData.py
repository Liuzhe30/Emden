...
def generate_all():
    ...
    feature_dataset_path = '../datasets/dataset_featurecode' + str(request_no) + '.dataset'
    all_data = alldata(feature_dataset_path)
    evidence_data_file_all = '../datasets/middlefile/test_data_evidence' + str(request_no) + '.dataset'
    ...
    processed_data_file_all = '../datasets/processed/test_data' + str(request_no) + '.pt'
    if ((not os.path.isfile(processed_data_file_all))):
        ...
        train_data = PyDataset(root='../datasets/', dataset='test' + str(request_no), xs=train_smile, xfp=train_fp, xsb=train_sb, xsa=train_sa, xv=train_variant, smile_graph=smile_graph)
