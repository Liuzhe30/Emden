...
## Online predict
[Emden Web Server](https://psymukb.net/Emden)
Note: Due to the hardware limitation, the server version of Emden do not contain features generated by Alphafold2(dssp and rASA). We strongly recommend that you use this locally installed version.
