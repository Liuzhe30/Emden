...
## Evaluate model
We provide the test dataset used in this study,  you can use [test_data.pt](https://github.com/Liuzhe30/Emden/tree/main/datasets/processed/test_data.pt) and download the model weights from [OneDrive url]() to evaluate our method.
